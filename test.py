...
test_update_state((0b00, 0.0), 2250.0, (0b00, 0.75))
test_update_state((0b00, 0.0), 4500.0, (0b01, 0.5))
test_update_state((0b00, 0.0), 6750.0, (0b11, 0.25))
...
test_update_state((0b01, 0.0), -2250.0, (0b00, 0.25))
test_update_state((0b01, 0.0), 0.0, (0b01, 0.0))
test_update_state((0b01, 0.0), 2250.0, (0b01, 0.75))
...
test_update_state((0b11, 0.0), -2250.0, (0b01, 0.25))
test_update_state((0b11, 0.0), 0.0, (0b11, 0.0))
test_update_state((0b11, 0.0), 2250.0, (0b11, 0.75))
...
test_update_state((0b00, 0.5), 750, (0b00, 0.75))
test_update_state((0b00, 0.5), 3750, (0b01, 0.75))
test_update_state((0b00, 0.5), 2250, (0b01, 0.25))
